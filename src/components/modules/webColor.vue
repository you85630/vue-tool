<template>
  <div class="web-color">
    <div class="color-list" v-for="(li,index) in colorList" :key="index">
      <div class="list-title">{{li.title}}</div>
      <div class="list-intro">{{li.intro}}</div>
      <div class="box">
        <div v-for="(i,index)  in li.table" :key="index">
          <div class="box-title">{{i.name}}</div>
          <div class="box-desc">{{i.desc}}</div>
          <div class="box-color">
